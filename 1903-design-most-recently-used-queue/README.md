<h2><a href="https://leetcode.com/problems/design-most-recently-used-queue">Design Most Recently Used Queue</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Design a queue-like data structure that moves the most recently used element to the end of the queue.</p>
